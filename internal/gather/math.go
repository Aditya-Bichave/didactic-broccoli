...
func computeCenter(cal CalibrationPayload) (centerX, centerY int) {
...
func computeProjectedOffset(cal CalibrationPayload, mode StepMode, distance, screenDX, screenDY float64) (projX, projY float64) {
...
func clampVector(dx, dy float64, centerX, centerY, left, right, top, bottom int) (clampedX, clampedY float64) {
	scale := 1.0
	if dx > 0 {
